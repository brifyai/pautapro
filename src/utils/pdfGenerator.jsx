...
<View style={styles.yearContainer}>
  ...
  <View style={styles.rowex}>
    ...
    <Text style={styles.infoValue}>{alternatives[0]?.Soportes?.nombreidentificador}</Text>
  </View>
...
export const generateOrderPDF = async (order, alternatives, cliente, campana, plan) => {
	try {
		...
		// IMPORTANTE: El PDF de la orden NO debe incluir información de rentabilidad
		// Solo debe mostrar los datos básicos de la orden, alternativas y totales
		// La rentabilidad se calcula y almacena internamente pero no se exporta en el PDF
