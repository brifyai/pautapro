...
async function obtenerNuevoIdProveedor() {
    try {
        let response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Proveedores?select=id_proveedor&order=id_proveedor.desc&limit=1", {
            method: "GET",
            headers: {
...
async function submitForm2(event) {
    ...
    try {
        ...
        let responseProveedor = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Proveedores", {
            method: "POST",
        ...
        if (responseProveedor.ok) {
            ...
            if (Array.isArray(formData.id_medios) && formData.id_medios.length > 0) {
                ...
                let responseProveedorMedios = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_medios", {
                    method: "POST",
