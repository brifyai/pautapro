async function getLastProveedorId() {
    ...
    try {
        const response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Proveedores?select=id_proveedor&order=id_proveedor.desc&limit=1", {
            method: "GET",
            headers: headersList
        });
...
async function submitForm(event) {
    ...
    try {
        const response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Proveedores", {
            method: "POST",
            body: bodyContent,
            headers: headersList
        });
        ...
        if (response.ok) {
            ...
            const soporteResponse = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes", {
                method: "POST",
