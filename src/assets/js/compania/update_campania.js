...
function cargarDatosFormulario(id) {
    ...
    const url = `https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Campania?id_campania=eq.${id}`;
...
function actualizarCompania() {
    ...
    const url = `https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Campania?id_campania=eq.${campaniaId}`;
