async function obtenerNuevoIdProveedor() {
    try {
        let response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Programas?select=id&order=id.desc&limit=1", {
            method: "GET",
            headers: {
...
async function submitForm2(event) {
    ...
    try {
        ...
        let responseProveedor = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Programas", {
            method: "POST",
        ...
        if (responseProveedor.ok) {
            ...
            if (Array.isArray(formData.id_medios) && formData.id_medios.length > 0) {
                ...
                let responseProveedorMedios = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/programa_medios", {
                    method: "POST",
