function loadsoportepro(button) {
    ...
    if (soporte) {
        ...
        fetch('https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/soporte_medios?select=*&id_soporte=eq.' + idSoporte, {
            method: "GET",
            headers: headersList
        })
...
async function submitForm3(event) {
    ...
    try {
        ...
        let response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes?id_soporte=eq.${idSoporte}`, {
            method: "PATCH",
        ...
        if (response.ok) {
            ...
            const deleteResponse = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/soporte_medios?id_soporte=eq.${idSoporte}`, {
                method: "DELETE",
                headers: headersList
            });
            ...
            if (deleteResponse.ok) {
                ...
                if (formData.id_medios && formData.id_medios.length > 0) {
                    ...
                    const insertResponse = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/soporte_medios", {
                        method: "POST",
