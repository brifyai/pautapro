...
document.addEventListener('DOMContentLoaded', function () {
    $('#agregarsoporteprov').on('shown.bs.modal', function (event) {
        ...
        fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_soporte?select=id_soporte&id_proveedor=eq.${idProveedor}`, {
            headers: {
        ...
        .then(proveedor_soportes => {
            ...
            const url = vinculados_str 
                ? `https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes?id_soporte=not.in.(${vinculados_str})&select=*`
                : `https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes?select=*`;
    ...
    fetch('https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_soporte', {
        method: 'POST',
        headers: {
...
async function obtenerNuevoIdSoporte() {
    try {
        let response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes?select=id_soporte&order=id_soporte.desc&limit=1", {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc",
...
async function submitFormSoporte2(event) {
    ...
    try {
        ...
        let responseSoporte = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Soportes", {
            method: "POST",
        ...
        if (responseSoporte.ok) {
            ...
            if (formData['id_medios[]']) {
                ...
                if (soporteMediosData.length > 0) {
                    let responseSoporteMedios = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/soporte_medios", {
                        method: "POST",
        ...
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc"
            ...
            let responseSoporteProveedor = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_soporte", {
                method: "POST",
