...
if (btnAddContrato) {
    ...
    function cargarProductoCliente(idCliente) {
        ...
        fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Productos?Id_Cliente=eq.${idCliente}&select=*`, {
            headers: {
    ...
    function filtrarMediosProveedor(idProveedor) {
        ...
        fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_medios?id_proveedor=eq.${idProveedor}&select=id_medio`, {
            headers: {
                "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc",
                "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc"
            }
        ...
        .then(relaciones => {
            if (relaciones.length > 0) {
                ...
                return fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Medios?id=in.(${idMedios.join(',')})&select=*`, {
                    headers: {
                        "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc",
                        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc"
                    }
    ...
    function submitForm() {
        ...
        fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Contratos", {
            method: "POST",
            body: bodyContent,
            headers: headersList
        })
