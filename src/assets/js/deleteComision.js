document.addEventListener('DOMContentLoaded', function() {
    ...
    function eliminarComision(idComision, rowElement) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Comisiones?id_comision=eq.${idComision}`, {
                    method: 'DELETE',
                    headers: {
    ...
    function agregarComision(formData) {
        ...
        fetch('https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Comisiones', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc'
