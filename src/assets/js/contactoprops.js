async function eliminarContacto(idContacto, idProveedor3) {
    ...
    try {
        ...
        const response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/contactos?id_contacto=eq.${idContacto}`, {
            method: 'DELETE',
            headers: {
...
console.log(data,"acutalizarrr");
    try {
        const response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/contactos?id_contacto=eq.${id}`, {
            method: 'PATCH',
            headers: {
