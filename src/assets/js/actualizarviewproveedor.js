...
async function submitForm3(event) {
    ...
    try {
        ...
        const response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Proveedores?id_proveedor=eq.${idProveedor}`, {
            method: "PATCH",
        ...
        if (response.ok) {
            ...
            const deleteResponse = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_medios?id_proveedor=eq.${idProveedor}`, {
                method: "DELETE",
                headers: headersList
            });
            ...
            if (deleteResponse.ok) {
                ...
                if (Array.isArray(formData.id_medios) && formData.id_medios.length > 0) {
                    ...
                    const insertResponse = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/proveedor_medios", {
                        method: "POST",
...
async function submitForm4(event) {
    ...
    try {
        // Actualizar el proveedor
        const response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Programas?id=eq.${idProgramas}`, {
            method: "PATCH",
        ...
        if (response.ok) {
            // Eliminar registros antiguos de proveedor_medios asociados al id_proveedor
            const deleteResponse = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/programa_medios?id_programa=eq.${idProgramas}`, {
                method: "DELETE",
                headers: headersList
            });
            ...
            if (deleteResponse.ok) {
                ...
                if (Array.isArray(formData.id_medios) && formData.id_medios.length > 0) {
                    ...
                    const insertResponse = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/programa_medios", {
                        method: "POST",
                        body: JSON.stringify(proveedorMediosData),
                        headers: headersList
                    });
