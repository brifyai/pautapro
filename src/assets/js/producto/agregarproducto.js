document.addEventListener('DOMContentLoaded', function () {
    ...
    async function cargarClientesMap() {
        ...
        try {
            const response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Clientes?select=id_cliente,nombreCliente", {
                method: "GET",
                headers: headersList
            });
    ...
    async function agregarProducto(nombreProducto, idCliente) {
        ...
        try {
            const response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Productos", {
                method: "POST",
                body: bodyContent,
                headers: headersList
            });
    ...
    async function actualizarTabla() {
        ...
        try {
            const response = await fetch("https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Productos?select=*", {
                method: "GET",
                headers: headersList
            });
