document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        try {
            ...
            const temaResponse = await fetch('https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Temas', {
                method: 'POST',
                headers: {
            ...
            const campaniaTemaResponse = await fetch('https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/campania_temas', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc',
...
document.getElementById('formularioactualizarTema').addEventListener('submit', async function(event) {
    ...
    try {
        let response = await fetch(`https://rfjbsoxkgmuehrgteljq.supabase.co/rest/v1/Temas?id_tema=eq.${idTema}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVreWp4emp3aHhvdHBkZnpjcGZxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyNzEwOTMsImV4cCI6MjAzNTg0NzA5M30.Vh4XAp1X6eJlEtqNNzYIoIuTPEweat14VQc9-InHhXc',
