...
-- Cliente 2 - Retail (Santiago Centro)
UPDATE clientes
SET
...
-- Cliente 3 - Construcción (Vitacura - Zona Alta)
UPDATE clientes
SET
...
-- Cliente 4 - Restaurantes (Las Condes - Zona Comercial)
UPDATE clientes
SET
...
-- Cliente 5 - Educación (Santiago Centro Financiero)
UPDATE clientes
SET
...
-- Cliente 6 - Logística (Quilicura - Zona Industrial)
UPDATE clientes
SET
    ...
    id_comuna = 256,  -- Quilpué
    direccion = 'Av. Los Carrera 1234, Parque Industrial',
    email = 'operaciones@logisticspro.cl',
    web_cliente = 'www.logisticspro.cl'
WHERE id_cliente = 6;

-- Cliente 7 - Moda (Las Condes - Zona Alta)
UPDATE clientes
SET
...
-- Cliente 8 - Energía Renovable (Concepción - Zona Centro)
UPDATE clientes
SET
...
-- Cliente 9 - Salud (Providencia - Zona Médica)
UPDATE clientes
SET
...
-- Cliente 10 - Automotriz (Maipú - Zona Industrial)
UPDATE clientes
SET
...
-- Cliente 11 - Finanzas (Santiago - Centro Financiero)
UPDATE clientes
SET
...
-- Cliente 12 - Medios (Providencia - Zona Cultural)
UPDATE clientes
SET
...
-- Cliente 13 - Deportes (Ñuble - Chillán)
UPDATE clientes
SET
...
-- Cliente 14 - Hogar (Viña del Mar - Zona Turística)
UPDATE clientes
SET
...
-- Cliente 15 - Turismo (Antofagasta - Zona Norte)
UPDATE clientes
SET
